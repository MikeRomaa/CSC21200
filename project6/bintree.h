...
class BinaryTreeNode {
    public:
        ...
        const BinaryTreeNode *left() const { return left_field; }

        const BinaryTreeNode *right() const { return right_field; }

        bool is_leaf() const { return (left_field == NULL) && (right_field == NULL); }

    private:
        Item data_field;
        BinaryTreeNode *left_field;
        BinaryTreeNode *right_field;
};
