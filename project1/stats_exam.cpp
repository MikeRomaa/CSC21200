...
int main() {
    ...
    value += result;
    if (result > 0)
        cerr << "Test 4 passed." << endl << endl;
    else
        cerr << "Test 4 failed." << endl << endl;
    ...
    value += result;
    if (result > 0)
        cerr << "Test 5 passed." << endl << endl;
    else
        cerr << "Test 5 failed." << endl << endl;
